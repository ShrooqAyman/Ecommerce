...
from . import views
from .forms import (UserLoginForm,UserEditForm,PwdResetForm, PwdResetConfirmForm)
...
urlpatterns = [
    path('login/', auth_views.LoginView.as_view(template_name='account/regestration/login.html' ,form_class=UserLoginForm), name='login'),
